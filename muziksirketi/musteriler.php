<?php
include("baglan.php");
$sorgu2 = $db->prepare('SELECT * FROM sanatcisiolmayanturlere_ilgisiolanlar');
$sorgu2->execute();
$sanatcisiolmayanturlere_ilgisiolanlarlist = $sorgu2->fetchAll(PDO::FETCH_OBJ);

$query1 = $db->query('SELECT * FROM sanatcisiolmayanturler');
         ...
         <script type="text/javascript">
            ...
            data.addRows([
                  ...
                  foreach($query1 as $row1) {
                     echo "['".$row1["tur_ad"]."',".$row1["musteriKaybi"]."],";
                  }
                  ?>
            ]);
            var options = {'title':'',
                           'width':500,
                           'height':400};
            var chart = new google.visualization.PieChart(document.getElementById('sotid_chart'));
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header"><strong>SANATÇISI OLMAYAN TÜRLERE İLGİ DUYAN MÜŞTERİ SAYILARI</strong></div>
                            <div class="card-body card-block">
                                <div id="sotid_chart"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">SANATÇISI OLMAYAN TÜRLERE İLGİ DUYAN YAŞ GRUPLARI</strong>
                            </div>
                            <div class="card-body">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <?php foreach ($sanatcisiolmayanturlere_ilgisiolanlarlist as $sotidl){?>
                                    <tbody>
                                        <tr>
                                            <td><?= $sotidl->il_id ?></td>
                                            <td><?= $sotidl->il_ad ?></td>
                                            <td><?= $sotidl->cinsiyet_ad ?></td>
                                            <td><?= $sotidl->yas_araligi_ad ?></td>
                                            <td><?= $sotidl->tur_ad ?></td>
                                            <td><?= $sotidl->nufus ?></td>
                                        </tr>
                                    </tbody>
