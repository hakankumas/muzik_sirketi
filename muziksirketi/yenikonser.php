        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header"><strong>YENİ KONSER PLANI EKLE</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="islem.php" method="post">
                                    <div>
                                        <input type="text" name="konseradi" id="konseradi" placeholder="Konser Adı" class="form-control" required autofocus>
                                    </div>
                                    <br>
                                    <select name="iladi" id="iladi" class="form-control" required>
                                        <option value="" disabled selected>İl Adı</option>
                                    ...
                                    <select name="sanatciadi" id="sanatciadi" class="form-control" required>
                                        <option value="" disabled selected>Sanatçı Adı</option>
                                    ...
                                    <select name="yasaraligi" id="yasaraligi" class="form-control" required>
                                        <option value="" disabled selected>Yaş Aralığı</option>
                                    ...
                                    <br>
                                    <div>
                                        <input type="text" name="biletfiyati" id="biletfiyati" placeholder="Bilet Fiyatı" class="form-control" required>
                                    </div> 
                                    <br>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">YENİ KONSERLER</strong>
                            </div>
                            <div class="card-body">
