                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">SPONSORLAR</strong>
                            </div>
                            <div class="card-body">
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Sponsor Adı</th>
                                            <th>Sponsorluk Ücreti</th>
                                            <th>Sponsorluk Sayısı</th>
                                        </tr>
                                    </thead>
                                    <?php foreach ($encoksponsorolansponsorlarlist as $ecsosl){?>
                                    <tbody>
                                        <tr>
                                            <td><?= $ecsosl->sponsor_ad ?></td>
                                            <td><?= $ecsosl->sponsor_ucret ?></td>
                                            <td><?= $ecsosl->sponsorlukSayisi ?></td>
                                        </tr>
                                    </tbody>
                                    <?php } ?>
                                </table>
